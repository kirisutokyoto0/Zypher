...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_type_spec = 17,                 /* type_spec  */
  YYSYMBOL_var_decl = 18,                  /* var_decl  */
  YYSYMBOL_19_1 = 19,                      /* $@1  */
  YYSYMBOL_var_init_list = 20,             /* var_init_list  */
  YYSYMBOL_var_init = 21,                  /* var_init  */
  YYSYMBOL_let_assignment = 22,            /* let_assignment  */
...
{
       0,   128,   128,   135,   142,   143,   147,   148,   149,   150,
     155,   160,   165,   173,   174,   178,   178,   184,   185,   189,
     195,   207,   224,   231,   240,   246
};
#endif
...
static const char *const yytname[] =
{
  ...
  "IDENTIFIER", "INT", "CHAR", "LET", "ERROR", "';'", "','", "'='",
  "$accept", "program", "stmt_list", "stmt", "type_spec", "var_decl",
  "$@1", "var_init_list", "var_init", "let_assignment", "assignment", YY_NULLPTR
};
...
{
       7,    -7,    -8,    -9,    -9,    23,    20,    16,    -9,    -9,
      -1,     0,     1,    -9,     2,    17,    -9,    -9,    25,    -9,
      -9,    -9,    -9,    -9,    -9,    -9,    -9,    15,    19,    21,
      -9,    -9,    -9,    22,    25,    -9,    -9,    -9
};
...
{
       0,     0,     0,    13,    14,     0,     0,     0,     4,    15,
       0,     0,     0,    12,     0,     0,     1,     5,     0,     9,
       6,    11,     8,    10,     7,    24,    25,     0,    19,    16,
      17,    22,    23,     0,     0,    20,    21,    18
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
      -9,    -9,    -9,    26,    -9,    -9,    -9,    -9,     3,    -9,
      -9
};
...
{
      19,    21,    23,    13,    14,    25,    26,    -3,     1,    20,
      22,    24,     2,     3,     4,     5,    -2,     1,    31,    32,
      16,     2,     3,     4,     5,    35,    36,     0,    15,    27,
      28,    33,    34,    17,     0,     0,     0,    37
};

static const yytype_int8 yycheck[] =
{
       1,     1,     1,    10,    12,     3,     4,     0,     1,    10,
      10,    10,     5,     6,     7,     8,     0,     1,     3,     4,
       0,     5,     6,     7,     8,     3,     4,    -1,     5,    12,
       5,    12,    11,     7,    -1,    -1,    -1,    34
};
...
{
       0,     1,     5,     6,     7,     8,    14,    15,    16,    17,
      18,    22,    23,    10,    12,     5,     0,    16,    19,     1,
      10,     1,    10,     1,    10,     3,     4,    12,     5,    20,
      21,     3,     4,    12,    11,     3,     4,    21
};
...
#line 1238 "parser.tab.c"
  ...
  case 11: /* stmt: let_assignment error  */
#line 160 "parser.y"
                           {
...
#line 1270 "parser.tab.c"
  ...
  case 15: /* $@1: %empty  */
#line 178 "parser.y"
                { current_decl_type = (yyvsp[0].ch); }
#line 1276 "parser.tab.c"
    break;

  case 16: /* var_decl: type_spec $@1 var_init_list  */
#line 178 "parser.y"
                                                          {
          printf("✓ Parsed %s declaration\n", (yyvsp[-2].ch) == 'i' ? "INT" : "CHAR");
      }
#line 1284 "parser.tab.c"
    break;

  case 19: /* var_init: IDENTIFIER  */
#line 189 "parser.y"
                 {
          if(add_new_var((yyvsp[0].id), current_decl_type, 0) != -1) {
...
#line 1312 "parser.tab.c"
  ...
  case 21: /* var_init: IDENTIFIER '=' CHARACTER  */
#line 207 "parser.y"
                               {
          int val = (int)(yyvsp[0].ch);
          if(current_decl_type == 'i') {
              // Implicitly convert char to int (ASCII value)
              if(add_new_var((yyvsp[-2].id), current_decl_type, val) != -1) {
                  printf("  → %s = '%c' (%d)\n", (yyvsp[-2].id), (yyvsp[0].ch), val);
              }
          } else {
              if(add_new_var((yyvsp[-2].id), current_decl_type, (yyvsp[0].ch)) != -1) {
                  printf("  → %s = '%c'\n", (yyvsp[-2].id), (yyvsp[0].ch));
              }
          }
          free((yyvsp[-2].id));
      }
#line 1331 "parser.tab.c"
  ...
  case 22: /* let_assignment: LET IDENTIFIER '=' NUMBER  */
#line 224 "parser.y"
                                {
          // 'let' for implicit typing based on value
          if(add_new_var((yyvsp[-2].id), 'i', (yyvsp[0].num)) != -1) {
...
#line 1343 "parser.tab.c"
  ...
  case 23: /* let_assignment: LET IDENTIFIER '=' CHARACTER  */
#line 231 "parser.y"
                                   {
          if(add_new_var((yyvsp[-2].id), 'c', (yyvsp[0].ch)) != -1) {
...
#line 1354 "parser.tab.c"
  ...
  case 24: /* assignment: IDENTIFIER '=' NUMBER  */
#line 240 "parser.y"
                            {
          if(add_or_update_var((yyvsp[-2].id), 'i', (yyvsp[0].num)) != -1) {
              printf("✓ Assigned %s = %d\n", (yyvsp[-2].id), (yyvsp[0].num));
          }
          free((yyvsp[-2].id));
      }
#line 1365 "parser.tab.c"
  ...
  case 25: /* assignment: IDENTIFIER '=' CHARACTER  */
#line 246 "parser.y"
                               {
          if(add_or_update_var((yyvsp[-2].id), 'c', (yyvsp[0].ch)) != -1) {
              printf("✓ Assigned %s = '%c'\n", (yyvsp[-2].id), (yyvsp[0].ch));
          }
          free((yyvsp[-2].id));
      }
